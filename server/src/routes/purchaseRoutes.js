...
import { createPurchase, deletePurchase, duplicatePurchase, getPurchase, getSupplierPriceHistory, listPurchases, purchaseRules, updatePurchase } from '../controllers/purchaseController.js';
...
purchaseRoutes.post('/:id/duplicate', duplicatePurchase);
